...
extension UIColor {
    ...
    @objc public convenience init(rgb: String, alpha: CGFloat, defaultColor: UIColor = UIColor.clear) {
        guard let color = try? UIColor(rgb_throws: rgb, alpha: alpha) else {
    ...
    @objc public convenience init(rgb_throws: String, alpha: CGFloat) throws {
        guard rgb_throws.hasPrefix("#") else {
            throw UIColorInputError.missingHashMarkAsPrefix
        }
        
        let hexString: String = rgb_throws.substring(from: rgb_throws.characters.index(rgb_throws.startIndex, offsetBy: 1))
